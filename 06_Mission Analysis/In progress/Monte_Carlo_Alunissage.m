...
params = struct( ...
  ...
  'Tmax', 100e3, 'm0', 18000, 'm_dry', 11000, 'tilt_max_deg', 150);
...
PCT = struct('x0',0.9,'x1',0.9,'z1',0.90,'vx1',0.80,'vz1',0.80);
ABS = struct('y0',15e3,'y1',0,'vy1',0);   % NEW: y0 varies ±50 km; y1/vy1 kept 0 here
